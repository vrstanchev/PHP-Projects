...
require_once 'c:/xampp/php/pear/PHPUnit/Runner/Version.php';

/**
 * Depending on version, include the proper PHPUnit support
 * @see PHPUnit_Autoload
 */
require_once (version_compare(PHPUnit_Runner_Version::id(), '3.5.0', '>=')) ? 'c:/xampp/php/pear/PHPUnit/Autoload.php' : 'c:/xampp/php/pear/PHPUnit/Framework.php';
